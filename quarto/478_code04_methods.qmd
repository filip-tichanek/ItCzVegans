...
To assess the predictive power of lipidome, metabolome, microbiome and pathway-related features on diet strategy, we employed Elastic Net logistic regression, utilizing the `glmnet` R package [@glmnet]. For each dataset (pathways, microbiome, metabolome and lipidome) we fitted separate models.
